...
const playerPools: Record<string, PlayerPool> = {
  ...
  thai_jun88k36: {
    very_high:["aroon11", "nus9331", "manus9331", "nuschai", "Patipan42"],
    high: ["manus9331", "nus9331", "aroon11", "nuschai", "Patipan42"],
    mid: ["ary11", "aroon11", "Patipan42" ],
    low: ["ary11"],
    all: ["ary11", "manus9331", "nus9331","aroon11", "nuschai", "Patipan42"]
  }
};
