...
const playerPools: Record<string, PlayerPool> = {
  thai_789bet: {
    ...
    all: ["vip0955171905", "poypy789", "aroon11", "VIP0955171905", "borvon", "kootong"]
  },
  thai_jun88k36: {
    very_high:["aroon11", "nus9331", "manus9331", "nuschai", "frankk2709", "lucifer101"],
    high: ["manus9331", "nus9331","aroon11", "nuschai", "frankk2709", "lucifer101"],
    mid: ["ary11", "nuschai", "frankk2709", "lucifer101"],
    low: ["ary11"],
    all: ["ary11", "manus9331", "nus9331","aroon11", "nuschai", "frankk2709", "lucifer101"]
  }
};
