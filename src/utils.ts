...
export function formatTelegramMessage(data: any): string {
  const playerId = (data.user || data.player_id || "-");
  ...
  if (site === "thai_789bet") {
    if (rewardUsers.includes(playerId)) {
      ...
      🏷️ *ทางเข้าเว็บไซต์ :* https://shorturl.asia/3Iw6T
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับรางวัลสมนาคุณลูกค้าโค้ดฟรีจาก 789BetThailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    } else if (freeUsers.includes(playerId)) {
      message = `🎯 *ยินดีด้วย! คุณได้รับรางวัลเครดิตฟรีจากกิจกรรม เครดิตถูกส่งเข้าบัญชีแล้ว*
      👤 *ยูสเซอร์:* ${maskUsername(playerId)}
      🏷️ *ทางเข้าเว็บไซต์ :* https://shorturl.asia/3Iw6T
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับรางวัลเครดิตฟรีจากกิจกรรมโค้ดฟรีจาก 789BetThailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    } else {
      message = `🎯 *ยินดีด้วย! คุณได้รับเครดิตจากแพ็กเกจยิงโค้ด เครดิตถูกส่งเข้าบัญชีแล้ว*
      👤 *ยูสเซอร์:* ${maskUsername(playerId)}
      🏷️ *ทางเข้าเว็บไซต์ :* https://shorturl.asia/3Iw6T
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับเครดิตจากแพ็กเกจยิงโค้ด 789BetThailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    }
    ...
    if (rewardUsers.includes(playerId)) {
      message = `🎯 *ยินดีด้วย! คุณได้รับรางวัลสมนาคุณลูกค้า เครดิตถูกส่งเข้าบัญชีแล้ว*
      👤 *ยูสเซอร์:* ${maskUsername(playerId)}
      🏷️ *ทางเข้าเว็บไซต์ :* http://shorturl.at/UcyVS
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับรางวัลสมนาคุณลูกค้าโค้ดฟรีจาก Jun88Thailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    } else if (freeUsers.includes(playerId)) {
      message = `🎯 *ยินดีด้วย! คุณได้รับรางวัลเครดิตฟรีจากกิจกรรม เครดิตถูกส่งเข้าบัญชีแล้ว*
      👤 *ยูสเซอร์:* ${maskUsername(playerId)}
      🏷️ *ทางเข้าเว็บไซต์ :* http://shorturl.at/UcyVS
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับรางวัลเครดิตฟรีจากกิจกรรมโค้ดฟรีจาก Jun88Thailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    } else {
      message = `🎯 *ยินดีด้วย! คุณได้รับเครดิตจากแพ็กเกจยิงโค้ด เครดิตถูกส่งเข้าบัญชีแล้ว*
      👤 *ยูสเซอร์:* ${maskUsername(playerId)}
      🏷️ *ทางเข้าเว็บไซต์ :* http://shorturl.at/UcyVS
      💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับเครดิตจากแพ็กเกจยิงโค้ด Jun88Thailand
      💰 *ยอดฟรีเครดิต:* ${points} บาท
      🔗 *ซื้อแพ็กเกจยิงโค้ด :* ${link}`;
    }
  } else {
