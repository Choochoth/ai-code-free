...
export function formatTelegramMessage(data: any): string {
  ...
  if (site === "thai_789bet") {
    message = `🎯 *ยินดีด้วย! โค้ดฟรีเครดิตถูกส่งเข้าบัญชีแล้ว*
    ...
    🔗 *ลิงก์ยูสที่ได้รับโค้ดวันนี้:* ${link}`;
      ...
      if (specialUsers.includes(playerId)) {
        message = `🎯 *ยินดีด้วย! โค้ดฟรีเครดิตถูกส่งเข้าบัญชีแล้ว*
        👤 *ยูสเซอร์:* ${maskUsername(playerId)}
        ...
        message = `🎯 *ยินดีด้วย! คุณได้รับรางวัลจากกิจกรรม AI สุ่มยิงโค้ดฟรี เครดิตถูกส่งเข้าบัญชีแล้ว*
        👤 *ยูสเซอร์:* ${maskUsername(playerId)}
        🏷️ *เว็บไซต์:* http://shorturl.at/UcyVS
        💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับโปรโมชั่นโค้ดฟรีเครดิตจาก Jun88Thailand
        💰 *ยอดฟรีเครดิต:* ${points} บาท
      ...
      if (specialUsers.includes(playerId)) {
        message = `🎯 *ยินดีด้วย! คุณได้รับรางวัลโค้ดฟรีชดเชยลูกค้า เครดิตถูกส่งเข้าบัญชีแล้ว*
        👤 *ยูสเซอร์:* ${maskUsername(playerId)}
        🏷️ *เว็บไซต์:* http://shorturl.at/UcyVS
        💬 *ข้อความจากระบบ:* ยินดีด้วย! คุณได้รับโปรโมชั่นโค้ดฟรีเครดิตจาก Jun88Thailand
        💰 *ยอดฟรีเครดิต:* ${points} บาท
